...
$result = Get-DnsServerResourceRecord -ZoneName $zoneDNS -RRType $entryType -ComputerName $serverDNS | Where-Object { $_.HostName -eq "_VLMCS._tcp" }
Get-DnsServerResourceRecord -ZoneName $zoneDNS -RRType $entryType -ComputerName $serverDNS | Where-Object { $_.HostName -eq "_VLMCS._tcp" }
